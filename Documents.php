...
<h1 align="center">Customer Document</h1><br /><br />
...
<!--<form action="InsertCustomer_doc.php" method="post" onsubmit="return validation()" >-->
    ...
    <tr>
    <td><!--<img src="img/view.gif" style="margin-left: 119%;margin-top: 14px;" onclick="view()">--></td><td><td>
    <td><p style="font-size:18px; margin-top: 10px;"><input type="button" value="View Customer Documents" onclick="view()" ></p></td>
    </tr>
    <tr>
    <td></td><td><td>
    <td><p style="font-size:18px;margin-left: -71px;margin-top: 20px;">Add customer documents</p> </td>
    </tr>
    <tr>
    <?php
    ...
    <select multiple="multiple" style="margin-left: 236px;margin-top: -110px;" name="doc_name[]" id="doc_name"  onclick="remList(this.value)">
    </select>
    </td>
    </tr>
    ...
    <td colspan="2"><input type="submit" value="Submit" style="margin-left: 768%;"/></td>
                ...
                <a style="margin-left: 331px;"  onclick="add()"><!--<img src="images/add.png" />-->Add New Documents</a>
                <table style="display:none;margin-left: 160px;margin-top: 8px;" id="add">
                 <tr>
    <td style="font-size:20px;">Document Name</td><td>:<td>
