...
<div id="page">
<h1 align="center">Add Credit  Tips</h1><br /><br />
<form action="InsertCreditTips.php" method="post"  onsubmit="return validation()" >
    ...
    <td><textarea name="Description" id="Description" class="ckeditor" rows="10" cols="25"></textarea></td>
    </tr>
