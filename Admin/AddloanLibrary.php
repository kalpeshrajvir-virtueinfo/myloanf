...
<div id="page">
<h1 align="center">Add Loan Library</h1><br /><br />
<form action="InsertLoanLibrary.php" method="post"  onsubmit="return validation()" >
            <table align="center" cellpadding="0" cellspacing="0" width="60%">
             <tr>
    <td style="font-size:20px;">Library name</td><td>:<td>
    <td><input type="text" name="libraryname" id="libraryname"/></td>
    </tr>
   
    <tr>
    <td style="font-size:20px;">Description</td><td>:<td>
    <td><textarea name="librarydetails" id="librarydetails" class="ckeditor" rows="10" cols="25"></textarea></td>
    </tr>
