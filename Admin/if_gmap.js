...
var def_zoomval = 15;
/*var def_longval = 144.962707;
var def_latval = -37.812711;*/
var def_longval = lng;
var def_latval = lat;
//alert(lng);
function if_gmap_init()
{
	...
	google.maps.event.addListener(gmapdata, 'click', function(event) {
		document.getElementById("longval").value = event.latLng.lng().toFixed(10);
		document.getElementById("latval").value = event.latLng.lat().toFixed(10);
