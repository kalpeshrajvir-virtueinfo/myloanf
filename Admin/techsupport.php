...
<div id="page">
<h1 align="center">Tech Support</h1><br /><br />
...
<?php
$selectbank="select * from tb_mail WHERE status='tech'";
...
<td width="14%" height="34"><a href="viewtechdetails.php?id=<?php echo $row['id']; ?>">View Details</a></td>
</tr>
<?php
}?>
</table>    
