...
<div id="wrapper">
   ...
   <form action="gzip.php"  method="post" onsubmit="return validation()">
		...
		<table style="margin-left:300px" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr><td>&nbsp;&nbsp;</td></tr> 
                <th>
                 <label>Address : </label><input id="txtAddress" type="text" class="text" name="txtAddress"  /><br/> <input type="button" id="btnGo" value="Go" /></th></tr>
   <tr><td>&nbsp;&nbsp;</td></tr> 
                <tr>
  ...
  <tr align="center">
     ...
     <tr>
    <td><b>Latitude</b></td>
    <td><input type="text" name="latval" id="latval" /></td>
    </tr>
     <tr><td>&nbsp;&nbsp;</td></tr> 
    <tr>
    <td><b>Longitude</b></td>
    <td><input type="text" name="longval" id="longval" /></td>
    </tr>
     <tr><td>&nbsp;&nbsp;</td></tr> 
    <tr align="left">
		<td colspan=2 align="right"align="center"></td></tr>
