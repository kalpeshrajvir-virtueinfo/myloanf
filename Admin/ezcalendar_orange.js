		...
		for (r=0;r<6;r++) {
			//getID("week"+r).innerHTML = getWeek(calendarDate);
				for (c=0;c<7;c++) {
					...
					getID("cell"+r+c).href ="javascript:setDateValue('" + formatNumber(calendarDate.getFullYear()) + dateSeparator + formatNumber(calendarDate.getMonth()+1) + dateSeparator + calendarDate.getDate() + "')";
					getID("cell"+r+c).title = calendarDate.getFullYear() + " " + fullMonths[calendarDate.getMonth()] + ", " + calendarDate.getDate();
