...
">Contact Sales</h1><br /><br />
<form method="post" action="contactsales.php" enctype="multipart/form-data" >
    ...
    <tr>
    <td style="font-size:20px;">Company Name</td><td>:<td>
    <td><input type="text" name="com" id="com" value="<?php echo $row['companyname'];?>" readonly="readonly"></td>
    </tr>
    <tr>
